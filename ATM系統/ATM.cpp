...
enum MenuOption { BALANCE_INQUIRY = 1, WITHDRAWAL, DEPOSIT, EXIT, ADMIN = 999};
...
Transaction *ATM::createTransaction( int type )
{
   ...
   switch ( type )
   {
      ...
      case DEPOSIT: // create new Deposit transaction
		 ...
		 break;
	  case ADMIN: // create new Deposit transaction
		  tempPtr = new Admin(currentAccountNumber, screen,
			  bankDatabase );
		  break;
